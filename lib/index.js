(function() {
  var MediaLibraryClient, request;
  ...
  MediaLibraryClient = (function() {
    ...
    MediaLibraryClient.prototype.tracks = function(query, callback) {
      ...
      return request.get(this._baseUrl + '/tracks').query(query).end(function(err, res) {
        if (err) {
          return callback(err);
        }
    ...
    MediaLibraryClient.prototype.artists = function(query, callback) {
      ...
      return request.get(this._baseUrl + '/artists').query(query).end(function(err, res) {
        if (err) {
          return callback(err);
        }
        return callback(null, res.body);
    ...
    MediaLibraryClient.prototype.albums = function(query, callback) {
      ...
      return request.get(this._baseUrl + '/albums').query(query).end(function(err, res) {
        if (err) {
          return callback(err);
        }
        return callback(null, res.body);
    ...
    MediaLibraryClient.prototype.find = function(query, callback) {
      ...
      return request.get(this._baseUrl + '/find').query(query).end(function(err, res) {
        if (err) {
          return callback(err);
        }
        return callback(null, res.body);
